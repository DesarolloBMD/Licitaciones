...
/* ==========================================
   MANEJO DE LOGS (GET ?accion=logs)
   ========================================== */
...
/* ==========================================
   AÑADIR CAMPOS DE CONTROL A TABLA PRINCIPAL
   ========================================== */
$pdo->exec('ALTER TABLE IF NOT EXISTS public."Procedimientos Adjudicados"
